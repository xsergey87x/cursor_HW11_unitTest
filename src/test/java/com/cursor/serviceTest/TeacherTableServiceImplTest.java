...
public class TeacherTableServiceImplTest {
    ...
    private StudentsGroup group = new StudentsGroup(2L, "firstGroup", null, null);
    ;
    private Teacher teacher = new Teacher(3L, "Peter", "Johnson", "male", 55, null);
    ;
...
//        teacher = new Teacher(3L,"Peter","Johnson","male",55, null);
//    }
